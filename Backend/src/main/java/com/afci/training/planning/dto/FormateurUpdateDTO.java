...
public class FormateurUpdateDTO {
    ...
    private Boolean soumettre; // si true, on positionne profilSoumisLe = now (candidature)

    public FormateurUpdateDTO() { }

    public FormateurUpdateDTO(Integer heuresMaxMensuelles, Boolean actif, BigDecimal tauxHoraire,
                              String zoneIntervention, Integer distanceMaxKm, String moyenDeDeplacement,
                              Integer anneesExperience, String bioCourte, String linkedinUrl,
                              String portfolioUrl, String statutJuridique, String siret,
                              Boolean ribFournit, Boolean profilComplet, Boolean soumettre) {
    ...
    public Boolean getSoumettre() { return soumettre; }
    public void setSoumettre(Boolean soumettre) { this.soumettre = soumettre; }
}
